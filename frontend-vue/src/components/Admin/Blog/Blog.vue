                    ...
                    <div class="">
                        <div class="lg:mr-4 bg-white p-4 shadow-lg rounded-md border-2 my-4">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input required type="text" class="w-full rounded-md px-3 py-2 border-2" v-model="blogName"
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input required type="text" class="w-full rounded-md px-3 py-2 border-2" v-model="author"
                                    placeholder="Nguyen Trung Dung,...">
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <h4 class="font-bold mb-2 text-md">publish</h4>
                                <select class="w-full rounded-md px-3 py-2 border-2" v-model="publish">
                                    <option v-for="publish in publishs" :key="publish" :value="publish.value">{{
                                        publish.name }}
                                    </option>
                                </select>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input required type="date" class="w-full rounded-md px-3 py-2 border-2" v-model="createDate">
                            </div>
                        </div>
                    </div>
                </div>
