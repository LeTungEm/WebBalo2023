                ...
                <div class="lg:flex justify-between">
                    <div class="mx-8 lg:w-1/2">
                        <swiper :spaceBetween="10" :navigation="true" :thumbs="{ swiper: thumbsSwiper }" class="mb-12">
                            <swiper-slide><img
                                    :src="'https://webbalo.online/data/images/balo/' + product.image_1" /></swiper-slide>
                            <swiper-slide><img
                                    :src="'https://webbalo.online/data/images/balo/' + product.image_2" /></swiper-slide>
                            <swiper-slide><img
                                    :src="'https://webbalo.online/data/images/balo/' + product.image_3" /></swiper-slide>
                            <swiper-slide><img
                                    :src="'https://webbalo.online/data/images/balo/' + product.image_4" /></swiper-slide>
                        </swiper>
