<template>
    <div @click="$emit('modelToggle', true)" v-bind:class="{ hidden: !status }"
      class="fixed top-20 w-full h-full">
      <div class="flex absolute top-2 right-2 w-3/4 md:w-1/2 lg:w-1/4">
        ...
        <div class="bg-white border-r-4 border-yellow-400 w-full p-4">
          <div>
            <p class="text-gray-600 font-bold">Notification</p>
